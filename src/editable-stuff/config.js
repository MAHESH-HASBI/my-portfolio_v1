...
const experiences = {
  ...
  data: [
    ...
    },
    {
      ...
      description: "➤ Led, mentored, and managed a team of 6 software engineering interns, fostering their growth through guidance and professional development opportunities.<br />➤ Orchestrated the development of a cross-platform application (iOS & Android) from scratch using React Native, a JavaScript framework. Integrated mobile UI components with backend functionality using Firebase SDK and Firebase Cloud Firestore for storage.<br />➤ Crafted and executed the app's development roadmap, efficiently distributing tasks among team members. Conducted code quality reviews and fostered a collaborative environment for streamlined progression.<br />➤ Provided technical expertise and guidance to address intricate challenges, empowering the team to make informed decisions.<br />➤ Ensured adherence to coding standards and best practices through meticulous code, architecture, and design reviews.<br />➤ Proactively managed team budget, encompassing resource allocation and tooling costs, including essential platforms like GitHub, Firebase, and JIRA.<br />➤ Collaborated seamlessly with cross-functional teams, gaining a comprehensive understanding of project requirements, scopes, and timelines."
    },
    {
